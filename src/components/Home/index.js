...
import bracesImage from '../../assets/braces.png'
import cleaning from '../../assets/cleaning.png'
import smiling from '../../assets/smiling.png'
import removal from '../../assets/toothremoval.png'
...
class Home extends Component {
  ...
  componentDidMount() {
    ...
    slideLeft.addEventListener('click', () => {
      container.scrollBy({
        top: 0,
        left: -350, // Adjust this value based on card width
        behavior: 'smooth',
      });
    });
        ...
        <div className="why">
          ...
          <div className="why-content">
            <div className="why1">
              ...
              <p>
                Our expert possesses the perfect blend of skills and ensures
            ...
            <div className="why1">
              ...
              <p>
                We take pride in offering cost-effective dental solutions that
                prioritize your budget without compromising on quality.
              </p>
            </div>
            <div className="why1">
              <h1 className="why-head">Best Dental Care</h1>
              <p>
                At our clinic, we go above and beyond to provide exceptional
                dental care, focusing on comprehensive solutions
              </p>
            </div>
            <div className="why1">
              <h1 className="why-head">Safety and Hygiene</h1>
              <p>
                We adhere to stringent protocols to maintain a hygienic
                environment, Your safety and well-being are our top priorities.
              </p>
            </div>
            <div className="why1">
              <h1 className="why-head">All About the Patient</h1>
              <p>
                We are passionate about putting our patients at the center of
                everything we do and offer dental care that exceeds their
                expectations.
              </p>
            </div>
          </div>
          ...
          <div>
            <div className="container">
              ...
              <div className="card">
                ...
                <p>
                  Now you can book appointments at RamaKrishna Dental Care with
                  just a phone call
                </p>
                <Link to="/appointment">
                  {' '}
            ...
            <div>
              ...
              <Link to="/services">
                ...
                <Link to="/services">
                  {' '}
                  <button type="button" className="serv-btn">
                   <img src={bracesImage} alt="Braces" className="offer-card-svg"/>
                                       Teeth Braces
                  </button>
                </Link>
                <Link to="/services">
                  {' '}
                  <button type="button" className="serv-btn">
                    <img src={cleaning} alt='Teeth Cleaning'className="offer-card-svg"/>
                    Teeth Cleaning
                  </button>
                </Link>
                <Link to="/services">
                  {' '}
                  <button type="button" className="serv-btn">
                  <img src ={smiling} alt='Smile Designing' className="offer-card-svg"/>
                    Smile Designing
                  </button>
                </Link>
                <Link to="/services">
                  {' '}
                  <button type="button" className="serv-btn">
                   <img src={removal} alt='Tooth Removal' className="offer-card-svg" />
                                       Teeth Extraction
                  </button>
                </Link>
                <Link to="/services">
                  {' '}
                  <button type="button" className="serv-btn">
                    <img src={gum} alt='Tooth Removal' className="offer-card-svg"/>
                    Gum Surgery
                  </button>
                </Link>
                <Link to="/services">
                  {' '}
                  <button type="button" className="serv-btn">
                  <img src={filling} alt='Tooth Removal' className="offer-card-svg"/>
            ...
            <div class="testimonial-slider">
              <div class="slider-arrow left-arrow" id="slideLeft">&#10094;</div>

              <div className="testimonial-container">
                <div className="testimonial">
                  <div className="stars">★★★★★</div>
                  <p>
                  I was nervous about getting a root canal, but the team at Rama Krishna Dental Clinic put my fears at ease. 
                  Dr. Ramakrishna explained the procedure thoroughly and made sure I was comfortable throughout. 
                  The procedure was smooth, and I experienced minimal pain. The clinic is well-equipped, and the staff is caring and attentive. 
                  Thank you for saving my tooth!
                  </p>
                  <h4>Tasleema V.</h4>
                </div>
                ...
                <div className="testimonial">
                  <div className="stars">★★★★</div>
                  <p>
                  After losing a tooth, I didn’t know how I would restore my smile. 
                  Dr. Ramakrishna suggested a dental bridge, and I’m glad I went ahead with it. 
                  The bridge looks and feels completely natural. 
                  The entire staff at the clinic is so welcoming, and they made sure I understood every step of the process. 
                  Excellent service!
                  </p>
                  <h4>Sirisha Sri</h4>
                </div>
                <div className="testimonial">
                  <div className="stars">★★★★</div>
                  <p>
                  The best dental clinic in Machilipatnam! The clinic is very clean, and the team is very welcoming. 
                  I had a tooth extraction, and the entire process was painless. 
                  Thank you, Dr. Ramakrishna, for the outstanding care.
                  </p>
                ...
                <div className="testimonial">
                  <div className="stars">★★★★★</div>
                  <p>
                  Excellent service! The staff at Ramakrishna Dental Clinic were very professional and friendly. 
                  Dr. Ramakrishna explained the entire procedure in detail and made me feel very comfortable. 
                  I highly recommend this clinic for anyone looking for quality dental care.
                  </p>
                  <h4>Suresh P.</h4>
                </div>
                <div className="testimonial">
                  <div className="stars">★★★★</div>
                  <p>
                  I went to Rama Krishna Dental Clinic for a routine check-up and found out I had a cavity. Dr. Ramakrishna filled it on the spot, and the process was seamless. I didn’t feel any pain, and my tooth looks as good as new. 
                  I really appreciate the personalized care and professionalism at this clinic.
                  </p>
                  <h4>Kavitha T.</h4>
                </div>
                <div className="testimonial">
                  <div className="stars">★★★★</div>
                  <p>
                  I had multiple missing teeth, and eating was becoming a problem. 
                  Dr. Ramakrishna recommended dental bridges, and I’m so glad I went for it. 
                  The bridge looks completely natural, and I can eat comfortably now. 
                  The doctor and his staff are extremely professional and accommodating, and they made the whole process stress-free.
                  </p>
                  <h4>Krishna M.</h4>
                </div>
              ...
              <div class="slider-arrow right-arrow" id="slideRight">&#10095;</div>
            </div>
