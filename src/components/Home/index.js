...
import hours from "../../assets/card2home-removebg-preview.png"
import appointment from "../../assets/card3home-removebg-preview.png"
import contact from "../../assets/card1home-removebg-preview.png"
...
class Home extends Component{
    ...
    <div class="container">
      <div class="card">
        <div class="icon">
          <img src={hours} class="card-icon" />
          
        </div>

        <h3>Opening Hours</h3>
        <p>
          Mon - Fri 10:00am - 08:00pm<br />Saturday 10:00am - 08:00pm<br />Sunday
          10:00am - 08:00pm
        </p>
      ...
      <div class="card">
        <div class="icon">
          <img src={appointment} class="card-icon" />
        </div>
        <h3>Make An Appointment</h3>
        <p>
          Now you can book appointments at Annapoorna International Dental Care
      ...
      <div class="card">
        <div class="icon">
          <img src={contact} class="card-icon" />
        </div>
        <h3>Contact Us Now</h3>
        <p>
          +917075997722, +918500155959<br />annapoornadentalcare@gmail.com<br />Vijayawada,
          Machilipatnam
        </p>
     ...
     <Link to="/services"> <button class="serv-btn">
          ...
          >
            ...
            >
              ...
              <stop offset=".283" stop-color="#dee9f9" />
              <stop offset=".704" stop-color="#f0f0f3" />
            ...
            >
              ...
              <stop offset="1" stop-color="#384051" stop-opacity=".4" />
            </linearGradient>
            <polygon
              fill="url(#c)"
    ...
    <section class="testimonials-section">
      ...
      <p>
        We’re committed to treating patients with the compassion and respect
        they deserve while still offering fair dental pricing.
      </p>
      ...
      <div class="testimonial-container">
        <div class="testimonial">
          <div class="stars">★★★★★</div>
          <p>
            It was a pleasant experience. The doctor and supporting staff are
            very dedicated and experienced. It is quite a spacious and
            well-equipped clinic. Very much satisfied with their treatment.
          </p>
          <h4>Naveen Kumar</h4>
        </div>
        ...
        <div class="testimonial">
          <div class="stars">★★★★★</div>
          <p>
            One of the best dental clinics that provide adequate treatment.
            Their teamwork is professional, the staff is always smiling and the
            doctor is very friendly. Highly recommended.
          </p>
          <h4>Pranathi Sri</h4>
        </div>
      </div>

      <Link to="/appointment"><button class="appointment-btn">Book an appointment today</button></Link>
    </section>
                </div>
            </div>
          </div>
